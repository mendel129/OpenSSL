...
.\openssl ca -passin pass:$interpass -config IssuingCATemplate.cnf -days 375 -extensions CustomPKIServerCert -notext -md sha256 -in leafs/csr/endentity_$($domainname).csr -out leafs/endentity_$($domainname).cert -batch
